...
""" SMP.py      ==> Singular Matrix Passivity enforcement
...
[3] Totorica, Nathan, GitHub, May 5, 2021. Accessed on: August 10, 2022, [Online]. Available:https://github.com/ntotorica/SMP_Passivity_Enforcement
...
class SMP(object):
    ...
    def SMP_driver(self, SER, Niter, s_pass):
        ...
        '''
        print("Starting SMP Perturbation:\n")
    ...
    def pass_check_Y(self, A, B, C, D):
        ...
        A = self.chomp(A) # Get rid of tiny imaginary numbers (in poles)
        ...
        S1 = A @ (B @ (np.linalg.matrix_power(D, -1)) @ C - A) # Eq. (23a) in [7] (Gustavsen passivity assessment through S matrix)
