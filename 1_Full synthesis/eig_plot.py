...
""" eig_plot.py     => This script plots the eigenvalues of G for passvity assessment
...
[1] Totorica, Nathan, GitHub, May 5, 2021. Accessed on: August 10, 2022, [Online]. Available:https://github.com/ntotorica/SMP_Passivity_Enforcement

[2] E. Medina, A. Ramirez, J. Morales and K. Sheshyekani, "Passivity Enforcement of FDNEs via Perturbation of Singularity Test Matrix," in IEEE Transactions on Power Delivery,
    vol. 35, no. 4, pp. 1648-1655, Aug. 2020, doi: 10.1109/TPWRD.2019.2949216.

[3] Houle, Jennifer, GitHub. May 10, 2020. Accessed on: February 3, 2021, [Online]. Available: https://github.com/jenniferEhoule/circuit_synthesis
...
def plot_eigenvalues_of_gs(plot_name, s_pass, graphs, ylim, labels):
    ...
    plt.tight_layout()
    plt.savefig('./Output/figures/Full_synthesis/eigenvalues_of_Gs.pdf')
