...
This program is based off intercheig.m from [5].

[1] Houle, Jennifer, GitHub. May 10, 2020. Accessed on: August 10, 2022, [Online]. Available: https://github.com/jenniferEhoule/circuit_synthesis
...
[4] D. Deschrijver, M. Mrozowski, T. Dhaene, and D. De Zutter,
    "Macromodeling of Multiport Systems Using a Fast Implementation of
    the Vector Fitting Method", IEEE Microwave and Wireless Components
    Letters, vol. 18, no. 6, pp. 383-385, June 2008.

[5] B. Gustavsen, Matrix Fitting Toolbox, The Vector Fitting Website.
